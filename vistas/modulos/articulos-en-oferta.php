      ...
      <div class="col-3-of-4">
        ...
        <?php
          ...
          if(isset($rutas[2])){
            ...
            $respuestaProduc = ControladorProductos::ctrMostrarProductosCategoriaGeneroLim($item, $valor, $item2, $valor2, $base, $tope);
            $respuestaProducPagi = ControladorProductos::ctrMostrarProductosCategoriasProductos($item2, $valor2, $item, $valor);
          }else{
              $item = "estado";
              $valor = "Oferta";
