...
<div class="lds-facebook"><div></div><div></div><div></div></div>
    ...
    <?php
            ...
            if(isset($_GET["ruta"])){
                ...
                }else if($rutas[0] == "inicio" || $rutas[0] == "salir" || $rutas[0] == "detalle-del-producto" || $rutas[0] == "carrito"  || $rutas[0] == "articulos-para-hombre" || $rutas[0] == "articulos-para-mujeres" || $rutas[0] == "articulos-para-ninios" || $rutas[0] == "articulos-personalizados" || $rutas[0] == "articulos-en-oferta" || $rutas[0] == "articulos-nuevos" || $rutas[0] == "cotizacion" || $rutas[0] == "personalizados"|| $rutas[0] == "perfil" || $rutas[0] == "imagenes"){
                    include "modulos/menuIni.php"; 
